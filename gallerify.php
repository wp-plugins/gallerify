...
function gallerify_shortcode($atts, $content = null) {
	...
	$output = '<div class="gallerify-container"><h3 class="gallerify-block-title">Gallery'.$gallerify_title.'</h3><div class="gallerify" data-allowfullscreen="'.$fullscreen.'" data-nav="'.$nav.'" data-keyboard="'.$keys.'"  data-autoplay="'.$autoplay.'" data-trackpad="'.$trackpad.'" data-ratio="800/500" data-width="100%">';
